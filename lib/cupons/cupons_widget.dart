...
import 'package:seus_cachoss/cupons/cupons_controller.dart';
...
class _CuponsWidgetState extends State<CuponsWidget> {
  List<CupomModel> lista = List.empty(growable: true);
  final cuponsController = CuponsController();
  ...
  Future<void> listar() async {
    lista = await cuponsController.listarCupom();
